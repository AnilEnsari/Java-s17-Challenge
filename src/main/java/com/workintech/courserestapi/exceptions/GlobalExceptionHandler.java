...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<CourseErrorResponse> handleException(CourseException exception) {
        CourseErrorResponse response = new CourseErrorResponse(exception.getStatus().value(), exception.getMessage(),
    ...
    public ResponseEntity<CourseErrorResponse> handleException(Exception exception) {
        ...
        CourseErrorResponse response = new CourseErrorResponse(HttpStatus.BAD_REQUEST.value(), exception.getMessage(),
                System.currentTimeMillis());
